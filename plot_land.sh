...
python plot_surface.py --cuda --model resnet20_noshort --x=-1:1:51 --y=-1:1:51 --model_file ./trained_nets/resnet20_noshort_sgd_lr\=0.1_bs\=512_wd\=0_mom\=0_save_epoch\=1/model_500.t7 --dir_type weights --xnorm filter --xignore biasbn --ynorm filter --yignore biasbn --plot
...
python plot_surface.py --cuda --model resnet14 --x=-1:1:51 --y=-1:1:51 --model_file ./trained_nets/resnet14_sgd_lr\=0.1_bs\=128_wd\=0_mom\=0_save_epoch\=1/model_500.t7 --dir_type weights --xnorm filter --xignore biasbn --ynorm filter --yignore biasbn --plot

python plot_surface.py --cuda --model resnet14_noshort --x=-1:1:51 --y=-1:1:51 --model_file ./trained_nets/resnet14_noshort_sgd_lr\=0.1_bs\=128_wd\=0_mom\=0_save_epoch\=1/model_500.t7 --dir_type weights --xnorm filter --xignore biasbn --ynorm filter --yignore biasbn --plot
