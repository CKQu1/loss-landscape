...
# python -m cifar10.main --model='resnet56_noshort' --epochs=500 --save_epoch=1
# python -m cifar10.main --model='resnet110_noshort' --epochs=500 --save_epoch=1
# python -m cifar10.main --model='resnet56' --epochs=500 --save_epoch=1
python -m cifar10.main --model='fc3' --epochs=1500 --save_epoch=1
python -m cifar10.main --model='fc20' --epochs=1500 --save_epoch=1
python -m cifar10.main --model='fc56' --epochs=1500 --save_epoch=1
python -m cifar10.main --model='fc110' --epochs=1500 --save_epoch=1
