...
#python -m cifar10.main --model='resnet20' --epochs=500  --batch_size=512
#python -m cifar10.main --model='resnet20' --epochs=500  --batch_size=1024

#python -m cifar10.main --model='resnet20_noshort' --epochs=500  --batch_size=512
#python -m cifar10.main --model='resnet20_noshort' --epochs=500  --batch_size=1024

python compute_hessian_eig_GZ.py --cuda --batch_size=128 --model='resnet14' --model_folder='./trained_nets/resnet14_sgd_lr=0.1_bs=128_wd=0_mom=0_save_epoch=1' --num_eigenthings=20

python compute_hessian_eig_GZ.py --cuda --batch_size=512 --model='resnet14' --model_folder='./trained_nets/resnet14_sgd_lr=0.1_bs=512_wd=0_mom=0_save_epoch=1' --num_eigenthings=20

python compute_hessian_eig_GZ.py --cuda --batch_size=512 --model='resnet20' --model_folder='./trained_nets/resnet20_sgd_lr=0.1_bs=512_wd=0_mom=0_save_epoch=1' --num_eigenthings=20

python compute_hessian_eig_GZ.py --cuda --batch_size=128 --model='resnet14_noshort' --model_folder='./trained_nets/resnet14_noshort_sgd_lr=0.1_bs=128_wd=0_mom=0_save_epoch=1' --num_eigenthings=20

python compute_hessian_eig_GZ.py --cuda --batch_size=512 --model='resnet14_noshort' --model_folder='./trained_nets/resnet14_noshort_sgd_lr=0.1_bs=512_wd=0_mom=0_save_epoch=1' --num_eigenthings=20
