...
cd /project/cortical/loss-landscape/trained_nets/resnet110_sgd_lr=0.1_bs=128_wd=0_mom=0_save_epoch=1
python /project/cortical/loss-landscape/save_weight_in_mat.py --model resnet110
